...
async def link_account(interaction: discord.Interaction):
    try:
        ...
        await interaction.response.send_message(embed=embed, ephemeral=True)
        logger.info(f"link-account called by discord_id {discord_id}")
    except Exception as e:
...
async def verify_code(interaction: discord.Interaction, code: str):
    try:
        ...
        embed.color = discord.Color.green()
        await interaction.response.send_message(embed=embed, ephemeral=True)
        logger.info(f"verify-code successful for discord_id {discord_id}, code {code}")
    except Exception as e:
...
async def change_account(interaction: discord.Interaction):
    try:
        ...
        embed.color = discord.Color.green()
        await interaction.response.send_message(embed=embed, ephemeral=True)
        logger.info(f"change-account successful for discord_id {discord_id}")
    except Exception as e:
